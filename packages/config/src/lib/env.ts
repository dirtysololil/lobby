...
const apiEnvSchema = z.object({
  ...
  MAX_CUSTOM_EMOJI_MB: z.coerce.number().positive().default(2),
  MAX_CUSTOM_EMOJI_DIMENSION: z.coerce.number().int().positive().default(256),
  ...
  MAX_GIF_MB: z.coerce.number().positive().default(12),
  MAX_GIF_DIMENSION: z.coerce.number().int().positive().default(1280),
  MAX_GIF_FRAMES: z.coerce.number().int().positive().default(400),
