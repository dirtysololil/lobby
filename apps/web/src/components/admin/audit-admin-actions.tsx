...
> = {
  audit: {
    ...
    description:
      "Будут удалены все записи журнала аудита из базы. После очистки останется только запись о самом действии, чтобы не потерять след операции.",
  ...
  cache: {
    title: "Очистить кэш?",
    description:
      "Будет сброшен кэш приложения Lobby во всех открытых вкладках и обновлены данные страницы. Кэш данных Next.js и кэш сессий Redis в текущем стеке не используются.",
