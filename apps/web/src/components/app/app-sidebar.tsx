...
function SidebarIconLink({
  ...
  return (
    <Link
      ...
      title={label}
      className={cn(
        "group relative inline-flex h-11 w-11 items-center justify-center rounded-[14px] text-[var(--text-dim)] transition-all duration-150 md:h-[52px] md:w-[52px] md:rounded-[15px]",
  ...
  return (
    <aside className="workspace-dock hidden bg-black md:static md:z-auto md:flex md:h-full md:w-[88px] md:flex-col md:border-r md:border-white/8 md:bg-black">
      <div className="hidden h-full items-center justify-between gap-2 px-2 py-2 md:flex md:flex-col md:items-center md:justify-start md:px-0 md:pb-4 md:pt-[28px]">
        ...
        <div className="hidden h-px w-[74px] bg-white/8 md:mt-[28px] md:block" />
        ...
        <div className="ml-auto flex items-center gap-1.5 md:ml-0 md:mt-auto md:w-full md:flex-col md:items-center md:gap-[18px] md:pb-3">
          ...
          {!isMessagesRoute ? (
            <LogoutButton
              ...
              variant="ghost"
              size="sm"
              className="hidden h-[52px] w-[52px] rounded-[15px] border-0 bg-transparent px-0 text-[var(--text-dim)] transition-all duration-150 hover:bg-[var(--bg-hover)] hover:text-white [&_svg]:h-[22px] [&_svg]:w-[22px] [&_svg]:stroke-[2.15] md:inline-flex"
            />
          ) : null}
          ...
          <Link
            ...
            title="Профиль"
            aria-label="Профиль"
            className="ml-1 inline-flex rounded-full border border-white/8 p-0.5 transition-all duration-150 hover:border-white/20 md:ml-0 md:mt-1"
          >
            <UserAvatar
              user={viewer}
              size="lg"
