...
export function AppHeader({ viewer }: AppHeaderProps) {
  ...
  return (
    <header className="social-shell rounded-[20px] p-2.5">
      <div className="flex flex-col gap-2.5 xl:flex-row xl:items-center xl:justify-between">
        <div className="min-w-0">
          ...
          <div className="mt-1.5 flex min-w-0 flex-wrap items-center gap-2.5">
            <h1 className="truncate font-[var(--font-heading)] text-[1.08rem] font-semibold tracking-[-0.04em] text-white lg:text-[1.2rem]">
              {meta.title}
            </h1>
          </div>
        </div>

        <div className="flex flex-col gap-2 xl:min-w-[500px] xl:flex-row xl:items-center xl:justify-end">
