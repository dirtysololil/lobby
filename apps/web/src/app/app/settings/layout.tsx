...
export default function SettingsLayout({
  ...
  return (
    <section className="h-full min-h-0 min-w-0 overflow-y-auto overscroll-contain">
      <div className="grid min-h-full content-start gap-3 px-3 py-3 md:px-4 md:py-4">
        <section className="flex flex-wrap items-end justify-between gap-3 border-b border-[var(--border-soft)] pb-3">
          <div>
            ...
            <p className="mt-1 text-sm text-[var(--text-dim)]">
              Настраивайте профиль, присутствие, аватары и уведомления, не
              выпадая из основного рабочего ритма.
            </p>
          </div>
        </section>
        {children}
